...
const SPINNER_FOR_ADD_FORM_SUBMIT = "SPINNER_FOR_ADD_FORM_SUBMIT";
...
const AddForm = (props) => {
  ...
  const isSubmitLoading = useSelector((state) => {
    return state.spinner.spinnerType === SPINNER_FOR_ADD_FORM_SUBMIT;
  });
  ...
  const onHandleSubmitEntry = async (e) => {
    ...
    dispatch(showSpinner(SPINNER_FOR_ADD_FORM_SUBMIT));
  ...
  return (
    <div className="AddForm-wrapper">
      <form className="AddForm">
        ...
        />
        {isSubmitLoading ? (
          <div className="AddForm-spinner">
            <Spinner />
          </div>
        ) : (
          <button
            className="AddForm-submit"
            type="submit"

...
const QuestionPanel = (props) => {
  ...
  return (
    <div
      className={`QuestionPanel-wrapper ${
    ...
    >
      <div className="QuestionPanel">
        ...
        <CSSTransition
          in={questionData.title !== undefined}
          timeout={700}
          classNames="fade"
          mountOnEnter
        >
          <div>
            ...
            <div className="QuestionPanel-info-bar">
              ...
              >{`Difficulty: ${
                questionData ? questionData.difficulty : ""
              }`}</span>
              <span className="QuestionPanel-revision">
                <span className="QuestionPanel-revision-label">
                  Revision Date:
                </span>
                <span className="QuestionPanel-datepicker">
                  <Datepicker
                    selected={reviewDate}
                    local="moment"
                ...
                {questionData.revisionDate !== -1 && (
                  <GarbageIcon
                    className={`QuestionPanel-revision-remove ${
                      !isSameReviewDate() &&
                      "QuestionPanel-revision-remove-withSave"
                    }`}
